resource "kubernetes_manifest" "serviceaccount_eck_operator_elastic_operator" {
  manifest = {
    "apiVersion" = "v1"
    "kind" = "ServiceAccount"
    "metadata" = {
      "labels" = {
        ...
        "helm.sh/chart" = "eck-operator-2.2.0"
      }
...
resource "kubernetes_manifest" "secret_eck_operator_elastic_operator_webhook_cert" {
  manifest = {
    "apiVersion" = "v1"
    "kind" = "Secret"
    "metadata" = {
...
resource "kubernetes_manifest" "configmap_eck_operator_elastic_operator" {
  manifest = {
    "apiVersion" = "v1"
    "data" = {
      "eck.yaml" = <<-EOT
      ...
      enable-webhook: true
      webhook-name: elastic-operator.eck-operator.k8s.elastic.co
      EOT
    }
    "kind" = "ConfigMap"
    "metadata" = {
  ...
  manifest = {
    ...
    "metadata" = {
      ...
      "labels" = {
        ...
        "app.kubernetes.io/version" = "2.2.0"
        "helm.sh/chart" = "eck-operator-crds-2.2.0"
      }
...
resource "kubernetes_manifest" "service_eck_operator_elastic_operator_webhook" {
  manifest = {
    "apiVersion" = "v1"
    "kind" = "Service"
    "metadata" = {
...
resource "kubernetes_manifest" "statefulset_eck_operator_elastic_operator" {
  manifest = {
    "apiVersion" = "apps/v1"
    "kind" = "StatefulSet"
    "metadata" = {
    ...
    "spec" = {
      ...
      "template" = {
        "metadata" = {
          "annotations" = {
            "checksum/config" = "433c5bca1cd89c815726d25110ed6a49da5f269befa2afbc35bac4a375b78415"
...
resource "kubernetes_manifest" "validatingwebhookconfiguration_elastic_operator_eck_operator_k8s_elastic_co" {
  manifest = {
